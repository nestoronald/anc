...
<form name="adminForm" id="adminForm" action="index.php" method="post" class="form form-horizontal form-horizontal-wide">
	...
	<fieldset>
		...
		<div class="control-group">
			<label class="control-label" for="badbehaviour"><?php echo JText::_('ATOOLS_LBL_WAF_OPT_BADBEHAVIOUR'); ?></label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="bbstrict"><?php echo JText::_('ATOOLS_LBL_WAF_OPT_BBSTRICT'); ?></label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="bbwhitelistip"><?php echo JText::_('ATOOLS_LBL_WAF_OPT_bbwhitelistip'); ?></label>
			<div class="controls">
