...
var jscolor = {
	...
	color : function(target, prop) {
		...
		this.pickerFaceColor = '#202020'; // CSS color
		this.pickerBorder = 1; // px
		this.pickerBorderColor = '#000 #000 #000 #000'; // CSS color
		this.pickerInset = 1; // px
		this.pickerInsetColor = '#404040 #404040 #404040 #404040'; // CSS color
		...
		function drawPicker(x, y) {
			...
			switch(modeID) {
				case 0: var padImg = '../../templates/abana_j25/warp/config/images/hs.png'; break;
				case 1: var padImg = 'hv.png'; break;
			}
			p.padM.style.backgroundImage = "url('"+jscolor.getDir()+"../../templates/abana_j25/warp/config/images/cross.gif')";
			p.padM.style.backgroundRepeat = "no-repeat";
			p.sldM.style.backgroundImage = "url('"+jscolor.getDir()+"../../templates/abana_j25/warp/config/images/arrow.gif')";
		...
		// require images
		switch(modeID) {
			case 0: jscolor.requireImage('../../templates/abana_j25/warp/config/images/hs.png'); break;
			case 1: jscolor.requireImage('../../templates/abana_j25/warp/config/images/hv.png'); break;
		}
		jscolor.requireImage('../../templates/abana_j25/warp/config/images/cross.gif');
		jscolor.requireImage('../../templates/abana_j25/warp/config/images/arrow.gif');
