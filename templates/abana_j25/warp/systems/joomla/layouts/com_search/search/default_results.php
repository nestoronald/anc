...
<div class="items">
	...
	<article class="item">
		...
		<header class="results">
			...
			<?php if ( $result->href ) : ?>
			<h2 class="title"><a href="<?php echo JRoute::_($result->href); ?>" <?php if ($result->browsernav == 1 ) echo 'target="_blank"'; ?>><?php  echo $this->escape($result->title); ?></a></h2>
			<?php else : ?>
			<h2 class="title"><?php echo $this->escape($result->title); ?></h2>
			<?php endif; ?>
