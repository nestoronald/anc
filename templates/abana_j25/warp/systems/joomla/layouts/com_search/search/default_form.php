...
<form class="box style" id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post" name="searchForm">
	...
	<fieldset>
		...
		<div>
			...
			<input type="text" name="searchword" id="search_searchword" size="30" maxlength="<?php echo $upper_limit; ?>" value="<?php echo $this->escape($this->origkeyword); ?>" class="inputbox" />			<button name="Search" onclick="this.form.submit()" class="button-color"><?php echo JText::_('COM_SEARCH_SEARCH'); ?></button>
		</div>
		...
		<?php if ($this->params->get('search_areas', 1)) : ?><br/><br/>
		<div>
