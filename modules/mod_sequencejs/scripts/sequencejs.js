...
(function($){	
	...
	var get = {
		...
		defaultPreloader: function(prependTo, transitions, prefix){
			...
			$(prependTo).prepend('<div id="sequence-preloader"><div class="preloading"><img src="modules/mod_sequencejs/images/sequence-preloader.png" alt="Sequence is loading, please wait..." />    <img src="modules/mod_sequencejs/images/sequence-preloader.png" alt="Sequence is loading, please wait..." />    <img src="modules/mod_sequencejs/images/sequence-preloader.png" alt="Sequence is loading, please wait..." /></div></div>');
		}
	},
	...
	defaults = {
		...
		pauseIconSrc: "modules/mod_sequencejs/images/pause-icon.png",
		pauseAlt: "Pause",
		keysNavigate: true,
